...
export function PageHero({
  ...
  return (
    <section data-bg="bg" className="relative overflow-hidden">
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div className="absolute -top-24 left-[-10%] h-[420px] w-[420px] rounded-full bg-[radial-gradient(circle,rgba(46,139,87,0.12),transparent_66%)]" />
      </div>
