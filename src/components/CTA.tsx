...
const variants: Record<Variant, string> = {
  // Single interactive accent, page-wide. Ghana-yellow fill carries dark ink text (WCAG).
  primary:
    "bg-accent text-ink shadow-[0_10px_24px_-12px_rgb(212_160_23_/_0.5)] hover:bg-accent-strong hover:-translate-y-0.5 hover:shadow-lift",
  outline:
